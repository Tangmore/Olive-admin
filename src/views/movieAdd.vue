    ...
    <div class="main">
      ...
      <el-form :label-position="labelPosition" label-width="90px" style='width:80%;margin:30px auto;'>
        ...
        <el-form-item label="主演：">
            <el-input type="text" style="width: 74%" placeholder="请输入主演名" v-model="info.infoList.starring" ></el-input>
          </el-form-item>
      ...
      export default {
        ...
        methods: {
          ...
          doSubmit() {
            ...
            // cnnsole.log(111111)
            var url = this.$store.state.globalSettings.apiUrl + 'movie/add';
